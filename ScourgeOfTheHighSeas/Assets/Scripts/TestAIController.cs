...
///ITS A COPY PASTED VERSION OF THE AI CONTROLLER DESIGNED TO WORK WITHOUT THE LEVELMANAGER
/// </summary>
...
public class TestAIController : MonoBehaviour {
	...
	public List<GameObject> m_CurrentComShips;
	public List<GameObject> m_CurrentPlayerShips;
